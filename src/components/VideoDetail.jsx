...
class VideoDetail extends React.Component {
  ...
  addVideo = () => {
    this.props
      .addVideo(this.props.userId, this.props.video.items[0].id)
        ...
        <React.Fragment>
          <div>
            <div className="container">
              <div className="row">
                <VideoPlayer className="mx-auto" videoId={id} />
              </div>
              <div className="row">
...
export default connect(mapStateToProps, { youTubeSearchSingleVideo, addVideo })(
  VideoDetail
);
